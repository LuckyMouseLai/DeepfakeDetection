...
class Xception(nn.Module):
    ...
    def features(self, input):
        ...
        x = self.block1(x)  # [-1, 128, 74, 74]
        x = self.block2(x)  # [-1, 256, 37, 37]
        x = self.block3(x)  # [-1, 728, 19, 19]
        ### Middle flow
        x = self.block4(x)
        x = self.block5(x)
        x = self.block6(x)
        ...
        x = self.block9(x)
        x = self.block10(x)
        x = self.block11(x)  # [-1, 728, 19, 19]
        ### Exit flow
        x = self.block12(x)  # [-1, 1024, 10, 10]

        x = self.conv3(x)  # [-1, 1536, 10, 10]
        x = self.bn3(x)
        x = self.relu(x)

        x = self.conv4(x)  # [-1, 2048, 10, 10]
        x = self.bn4(x)
        return x
